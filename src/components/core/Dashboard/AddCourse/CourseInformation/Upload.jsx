...
export default function Upload({
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <div
        className={`${
          isDragActive ? "bg-richblack-900 bg-opacity-60 " : "rounded-md bg-gradient-to-r from-blue-400 to-blue-700 font-sm placeholder-white border-blue-100 border-2 py-2 px-5  text-white"
