  ...
  return (
    <div className='mt-[130px] mb-32'>
      <div className='flex flex-col gap-5 items-center'>
          ...
          <div className='text-center text-richblack-600 mx-auto text-base font-medium w-[68%]'>
          ...
          <div className='flex items-center justify-center mt-5'>
            ...
            />
            <img src={compare_with_others} alt="knowYourprogressImage"
                className='object-contain'
            />
            <img src={plan_your_lesson} alt="knowYourprogressImage"
